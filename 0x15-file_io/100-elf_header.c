...
/**
 * print_magic -prints magic nombas of an ELF header.
 * @e_ident:pointer to an array containing the ELF magic nombas.
 *
 * Description: Magic nombas are separated by spaces
 */
void print_magic(unsigned char *e_ident)
{
	int index;
...
/**
 * print_data Pprints the data of an ELF header.
 * @e_ident:pointer to an array containing the ELF class.
 */
void print_data(unsigned char *e_ident)
{
 ...
 * @argc:Nomba of arguments supplied to the program.
